...
#import "ERPlace.h"
#import "ERPlacesErrors.h"



@class ERAutocompleteFilter;
@class ERAutocompletePrediction;
@class ERPlaceLikelihoodList;
@class ERPlacePhotoMetadata;
@class ERPlacePhotoMetadataList;
 ...
 * @param result The |ERPlace| that was returned.
 * @param error The error that occurred, if any.
 *
 * @related ERPlacesClient
 */
typedef void (^ERPlaceResultCallback)(ERPlace *_Nullable result, NSError *_Nullable error);
 ...
 * @related ERPlacesClient
 */
typedef void (^ERPlaceLikelihoodListCallback)(ERPlaceLikelihoodList *_Nullable likelihoodList,
                                               NSError *_Nullable error);

/**
 * Callback type for receiving autocompletion results. |results| is an array of
 * ERAutocompletePredictions representing candidate completions of the query.
 * @param results An array of |ERAutocompletePrediction|s.
 * @param error The error that occurred, if any.
 *
 * @related ERPlacesClient
 */
typedef void (^ERAutocompletePredictionsCallback)(
                                                   NSArray<ERAutocompletePrediction *> *_Nullable results, NSError *_Nullable error);
 ...
 * @param photos The result containing |ERPlacePhotoMetadata| objects.
 * @param error The error that occurred, if any.
 *
 * @related ERPlacesClient
 */
typedef void (^ERPlacePhotoMetadataResultCallback)(ERPlacePhotoMetadataList *_Nullable photos,
                                                    NSError *_Nullable error);

/**
 * Callback type for receiving |UIImage| objects from a |ERPlacePhotoMetadata| object. If an error
 ...
 * @related ERPlacesClient
 */
typedef void (^ERPlacePhotoImageResultCallback)(UIImage *_Nullable photo,
                                                 NSError *_Nullable error);

/**
 * Main interface to the Places API. Used for searching and getting details about places. This class
 * should be accessed through the [ERPlacesClient sharedClient] method.
 *
 * ERPlacesClient methods should only be called from the main thread. Calling these methods from
 ...
 */
@interface ERPlacesClient : NSObject

/**
 * Provides the shared instance of ERPlacesClient for the Boobuz Places API for iOS, creating it if
 * necessary.
 *
 * If your application often uses methods of ERPlacesClient it may want to hold onto this object
 * directly, as otherwise your connection to Boobuz may be restarted on a regular basis.
 */
+ (instancetype)sharedClient;


///**
// * Returns the open source software license information for the Boobuz Places API for iOS. This
// * information must be made available within your application.
// */
//+ (NSString *)openSourceLicenseInfo;
/**
 * Returns the version for this release of the Boobuz Places API for iOS.
 */
+ (NSString *)SDKVersion;


/**
 * Provides your API key to the Boobuz Places API for iOS. This key is generated for your
 * application via the Boobuz APIs Console, and is paired with your application's bundle ID to
 ...
 */
- (void)lookUpPlaceID:(NSString *)placeID callback:(ERPlaceResultCallback)callback;
 ...
 * by Boobuz+ users. In most cases, these photos can be used without attribution, or will have the
...
- (void)lookUpPhotosForPlaceID:(NSString *)placeID
                      callback:(ERPlacePhotoMetadataResultCallback)callback;
 ...
 */
- (void)loadPlacePhoto:(ERPlacePhotoMetadata *)photo
              callback:(ERPlacePhotoImageResultCallback)callback;
 ...
 */
- (void)currentPlaceWithCallback:(ERPlaceLikelihoodListCallback)callback;
...
- (void)autocompleteQuery:(NSString *)query
                   bounds:(nullable ERCoordinateBounds *)bounds
                 callback:(ERAutocompletePredictionsCallback)callback;
