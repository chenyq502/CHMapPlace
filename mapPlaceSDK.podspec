...
s.source       = { :git => "https://github.com/chenyq502/CHMapPlace.git", :tag => "0.0.2" }         #存储库的git地址，以及tag值
#s.source_files  =  "MapPlaceSDK/**/*.{h,m}" #需要托管的源代码路径
s.vendored_frameworks = ['MapPlaceSDK/ERMapBaseSDK.framework','MapPlaceSDK/ERMapPlacesSDK.framework']
